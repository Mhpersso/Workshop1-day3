...
# This script is to analyse RNAseq data from the dataset GSE135448 using DESeq2 package. 
...
```{r}
#Extract the dietary intervention groups from metadata
...
```{r}
#Create a data frame that includes the PCA results and group information
